  ...
  renderTrailInput() {
    ...
    if (this.state.inputType === 'Percentage') {
      return (
        <Wrapper>
          ...
          <ShareSearch className="trailPercentageInput" placeholder={this.state.trailP} type="text" value={this.state.trailP} name="trailP" onChange={this.handleTrailPChange}></ShareSearch>
        </Wrapper>
      );
    }
    if (this.state.inputType === 'Amount') {
      return (
        <Wrapper>
          <WhiteText>Trail ($)</WhiteText>
          <ShareSearch className="trailPercentageInput" placeholder={this.state.trailD} type="text" value={this.state.trailD} name="trailD" onChange={this.handleTrailDChange}></ShareSearch>
        </Wrapper>
      );
    }
  }
    ...
    if (reviewOrder === 'false') {
      ...
      return (
        <div className="falseReviewOrder">
          ...
          <WhiteTextMessage>Please Deposit {this.props.stock.price} to purchase {this.state.shares} share at market price (5% collar included).</WhiteTextMessage>
      ...
      <div>
        <form className="TrailingStopOrderForm">
          ...
          <Wrapper>
            ...
            <GoodForDay onChange={this.handleTrailInputChange}>
              <Options value="Percentage">Percentage</Options>
              <Options value="Amount">Amount</Options>
            </GoodForDay>
          </Wrapper>
          <div>
          ...
          <MarketPrice>Market Price {this.props.stock.price}</MarketPrice>
